...
public class PrepaymentState {
    ...
    public void storePrePayment(String item_code, int item_num, String cert_code) {
        String insertSql = "INSERT INTO prepayment (item_code, item_num, cert_code) VALUES (?, ?, ?)";
        try (PreparedStatement insertStmt = connection.prepareStatement(insertSql)) {
            insertStmt.setString(1, item_code);
    ...
    public Map<String, String> checkCode(String cert_code) {
